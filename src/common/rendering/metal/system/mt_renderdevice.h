...
public:
	...
	MtResourceBindingManager* GetResourceBindingManager() { return mResourceBindingManager.get(); }
	MtPipelineStateManager* GetPipelineStateManager() { return mPipelineStateManager.get(); }
	...
	int Backend() override { return 2; } // 0=OpenGL, 1=Vulkan, 2=Metal
